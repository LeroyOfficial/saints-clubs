        ...
        <form class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
                <input class="bg-light form-control border-0 small" 
                    type="text" 
                    placeholder="Search for @if($page_title == 'Students')students @elseif($page_title == 'Clubs')clubs @else... @endif
                        "
                    >
        ...
        <ul class="navbar-nav flex-nowrap ms-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <div class="nav-item dropdown no-arrow">
                    ...
                    <img class="border rounded-circle img-profile" src="{{asset('admin/assets/img/avatars/2.jpg')}}">
                </a>
